/**
 * Agent settings section: pick a provider (Gemini / OpenAI / Anthropic) and bring your own key
 ...
 * agent. Rendered as one tab of the Settings panel (SettingsPanel.tsx), opened from the gear
 * at the bottom of the activity rail. See docs/AGENT.md, src/audio/agent/config.ts, and
 * src/audio/agent/providers.ts.
 */
...
export function AgentSettingsSection({ config, onClose }: { config: AgentConfig; onClose: () => void }) {
