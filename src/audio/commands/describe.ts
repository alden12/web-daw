...
const DESCRIBE: DescribeMap = {
  ...
  updateCustomInstrument: (command) => `Edited instrument "${command.def.label ?? command.def.type}"`,
  updateCustomEffect: (command) => `Edited effect "${command.def.label ?? command.def.type}"`,
